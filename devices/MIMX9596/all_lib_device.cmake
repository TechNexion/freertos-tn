...
#set.board.imx95lp4xevk15
#  # description: Board_project_template imx95lp4xevk15
#  set(CONFIG_USE_board_project_template true)

#set.board.imx95verdinevk
#  # description: Board_project_template imx95verdinevk
#  set(CONFIG_USE_board_project_template true)

#set.board.imx95lpd5evk19
#  # description: Board_project_template imx95lpd5evk19
#  set(CONFIG_USE_board_project_template true)
...
#  # description: Component sm_crc
#  set(CONFIG_USE_component_sm_crc true)

#  # description: Component sm_scmi
#  set(CONFIG_USE_component_sm_scmi true)

#  # description: Component sm_smt
...
#  # description: Devices_project_template MIMX9596
...
#  # description: Device MIMX9596_cmsis
#  set(CONFIG_USE_device_CMSIS true)

#  # description: Device MIMX9596_system
#  set(CONFIG_USE_device_system true)

#  # description: Device MIMX9596_startup
...
#  # description: System Manager Agent porting layer for cortex-m33 of imx95
#  set(CONFIG_USE_component_sm_imx95_cm33 true)

#  # description: System Manager Agent porting layer for cortex-m7 of imx95
#  set(CONFIG_USE_component_sm_imx95_cm7 true)

#  # description: Component sm_clock
#  set(CONFIG_USE_component_sm_clock true)

#  # description: Component sm_pinctrl
#  set(CONFIG_USE_component_sm_pinctrl true)

#  # description: Component sm_power
...
#  # description: SAR_ADC Driver
#  set(CONFIG_USE_driver_sar_adc true)
...
#  # description: Driver netc imx95
#  set(CONFIG_USE_driver_netc_imx95 true)

#  # description: NETC Switch Driver
#  set(CONFIG_USE_driver_netc_switch true)

#  # description: NETC PHY Wrapper Driver
#  set(CONFIG_USE_driver_netc_phywrapper true)

#  # description: NETC VSI-PSI Message Driver
#  set(CONFIG_USE_driver_netc_msg true)
...
#  set(CONFIG_USE_driver_mipi_dsi_imx true)

#  # description: DWC MIPI CSI2RX Driver
...
#  # description: DPU Driver
#  set(CONFIG_USE_driver_dpu_1 true)

#  # description: camera_csr Driver
...
#  # description: Driver srtm pdm edma adapter
#  set(CONFIG_USE_component_srtm_pdm_edma_adapter true)

#  # description: Driver srtm sai edma adapter
#  set(CONFIG_USE_component_srtm_sai_edma_adapter true)
...
#  # description: Driver srtm sensor adapter
#  set(CONFIG_USE_component_srtm_pf1550_adapter true)

#  # description: Driver srtm pmic service
#  set(CONFIG_USE_component_srtm_pmic_service true)

#  # description: Driver srtm pwm service
#  set(CONFIG_USE_component_srtm_pwm_service true)

#  # description: Driver srtm pwm adapter
#  set(CONFIG_USE_component_srtm_pwm_adapter true)

#  # description: Driver srtm rtc service
#  set(CONFIG_USE_component_srtm_rtc_service true)
...
#  # description: Component hal power
#  set(CONFIG_USE_component_hal_power true)

#  # description: power porting layer for imx95
...
#  # description: Component hal pinctrl
#  set(CONFIG_USE_component_hal_pinctrl true)

#  # description: pinctrl porting layer for imx95
...
#  # description: Component hal clock
#  set(CONFIG_USE_component_hal_clock true)

#  # description: clock porting layer for imx95
...
#  # description: RPMsg-Lite for i.MX95 application
#  set(CONFIG_USE_middleware_multicore_rpmsg-lite_imx95_m7 true)

#  # description: RPMsg-Lite for i.MX95 application
#  set(CONFIG_USE_middleware_multicore_rpmsg-lite_imx95_m33 true)
...
#  # description: Voice Spot library for i.MX95 Cortex M7
#  set(CONFIG_USE_middleware_voice_spot_cm7_iMX95 true)

#set.middleware.audio_voice.components.voice_seeker
#  # description: Voice seeker library for Cortex M7 on i.MX95
#  set(CONFIG_USE_middleware_audio_voice_components_voice_seeker_cm7_iMX95 true)

#  # description: Voice seeker memory utilities for Cortex M7
#  set(CONFIG_USE_middleware_audio_voice_components_voice_seeker_rdsp_utilities_public_cm7_iMX95 true)
...
#  # description: NETC ethernet interface non_generated_lwipopts
#  set(CONFIG_USE_middleware_lwip_netc_ethernetif_non_generated_lwipopts true)
...
#set.middleware.g2d
#  # description: G2D library
#  set(CONFIG_USE_middleware_g2d_cm7 true)
...
list(APPEND CMAKE_MODULE_PATH
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../boards/imx95lp4xevk15/project_template
  ${CMAKE_CURRENT_LIST_DIR}/../../boards/imx95lpd5evk19/project_template
  ${CMAKE_CURRENT_LIST_DIR}/../../boards/imx95verdinevk/project_template
  ${CMAKE_CURRENT_LIST_DIR}/../../components/audio
  ${CMAKE_CURRENT_LIST_DIR}/../../components/button
  ${CMAKE_CURRENT_LIST_DIR}/../../components/clock
  ${CMAKE_CURRENT_LIST_DIR}/../../components/clock/porting/platform/imx95
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../components/imx_sm_crc
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../components/pinctrl
  ${CMAKE_CURRENT_LIST_DIR}/../../components/pinctrl/porting/platform/imx95
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../components/power
  ${CMAKE_CURRENT_LIST_DIR}/../../components/power/porting/platform/imx95
  ${CMAKE_CURRENT_LIST_DIR}/../../components/pwm
  ${CMAKE_CURRENT_LIST_DIR}/../../components/reset
  ${CMAKE_CURRENT_LIST_DIR}/../../components/rng
  ${CMAKE_CURRENT_LIST_DIR}/../../components/scmi
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../components/sm/clock
  ${CMAKE_CURRENT_LIST_DIR}/../../components/sm/pinctrl
  ${CMAKE_CURRENT_LIST_DIR}/../../components/sm/porting/platform/imx95/cm33
  ${CMAKE_CURRENT_LIST_DIR}/../../components/sm/porting/platform/imx95/cm7
  ${CMAKE_CURRENT_LIST_DIR}/../../components/sm/power
  ${CMAKE_CURRENT_LIST_DIR}/../../components/smt
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../middleware/audio_voice/components/voice_seeker/i.MX95_CortexM7
  ${CMAKE_CURRENT_LIST_DIR}/../../middleware/audio_voice/components/voice_seeker/i.MX95_CortexM7/rdsp_utilities_public
  ${CMAKE_CURRENT_LIST_DIR}/../../middleware/audio_voice/components/voice_spot
  ${CMAKE_CURRENT_LIST_DIR}/../../middleware/bm
  ${CMAKE_CURRENT_LIST_DIR}/../../middleware/g2d_dpu
  ${CMAKE_CURRENT_LIST_DIR}/../../middleware/llhttp
  ${CMAKE_CURRENT_LIST_DIR}/../../middleware/lwip
  ${CMAKE_CURRENT_LIST_DIR}/../../middleware/multicore
  ${CMAKE_CURRENT_LIST_DIR}/../../middleware/multicore/mcmgr
  ${CMAKE_CURRENT_LIST_DIR}/../../middleware/multicore/rpmsg-lite
...
include_if_use(board_project_template)
include_if_use(board_project_template)
include_if_use(component_ak4497_adapter.MIMX9596)
include_if_use(component_at_least_one_i2c_mux_device_enabled.MIMX9596)
include_if_use(component_audio_sai_edma_adapter.MIMX9596)
include_if_use(component_button.MIMX9596)
include_if_use(component_codec_adapters.MIMX9596)
include_if_use(component_codec_i2c.MIMX9596)
include_if_use(component_common_task)
include_if_use(component_cs42448_adapter.MIMX9596)
include_if_use(component_cs42888_adapter.MIMX9596)
include_if_use(component_da7212_adapter.MIMX9596)
include_if_use(component_enable_pca9544.MIMX9596)
include_if_use(component_enable_pca9548.MIMX9596)
include_if_use(component_eth_phy_common.MIMX9596)
include_if_use(component_flash_nand_flexspi.MIMX9596)
include_if_use(component_flash_nor_flexspi.MIMX9596)
include_if_use(component_flash_nor_lpspi.MIMX9596)
include_if_use(component_hal_clock.MIMX9596)
include_if_use(component_hal_clock_imx95.MIMX9596)
include_if_use(component_hal_pinctrl.MIMX9596)
include_if_use(component_hal_pinctrl_imx95.MIMX9596)
include_if_use(component_hal_power.MIMX9596)
include_if_use(component_hal_power_imx95.MIMX9596)
include_if_use(component_i2c_adapter_interface.MIMX9596)
include_if_use(component_i2c_mux_pca954x.MIMX9596)
include_if_use(component_i3c_adapter.MIMX9596)
include_if_use(component_i3c_bus.MIMX9596)
include_if_use(component_i3c_bus_adapter.MIMX9596)
include_if_use(component_lists.MIMX9596)
include_if_use(component_lpi2c_adapter.MIMX9596)
include_if_use(component_lpit_adapter.MIMX9596)
include_if_use(component_lpspi_adapter.MIMX9596)
include_if_use(component_lptmr_adapter.MIMX9596)
include_if_use(component_lpuart_adapter.MIMX9596)
include_if_use(component_mem_manager.MIMX9596)
include_if_use(component_mem_manager_freertos.MIMX9596)
include_if_use(component_mem_manager_legacy.MIMX9596)
include_if_use(component_mem_manager_light.MIMX9596)
include_if_use(component_mflash_offchip.MIMX9596)
include_if_use(component_mflash_onchip.MIMX9596)
...
include_if_use(component_panic.MIMX9596)
include_if_use(component_pcm186x_adapter.MIMX9596)
include_if_use(component_pcm512x_adapter.MIMX9596)
include_if_use(component_phyaqr113c.MIMX9596)
include_if_use(component_phyar8031.MIMX9596)
include_if_use(component_phydp8384x.MIMX9596)
include_if_use(component_phygpy215.MIMX9596)
include_if_use(component_phyksz8041.MIMX9596)
include_if_use(component_phyksz8081.MIMX9596)
include_if_use(component_phylan8720a.MIMX9596)
include_if_use(component_phylan8741.MIMX9596)
include_if_use(component_phyrtl8201.MIMX9596)
include_if_use(component_phyrtl8211f.MIMX9596)
include_if_use(component_phytja1100.MIMX9596)
include_if_use(component_phytja1120.MIMX9596)
include_if_use(component_phyvsc8541.MIMX9596)
include_if_use(component_phyyt8521.MIMX9596)
include_if_use(component_pwm_tpm_adapter.MIMX9596)
include_if_use(component_reset_adapter.MIMX9596)
include_if_use(component_rgpio_adapter.MIMX9596)
include_if_use(component_rng_adapter_interface.MIMX9596)
include_if_use(component_rnga_adapter.MIMX9596)
include_if_use(component_rpmsg_endpoint.MIMX9596)
include_if_use(component_serial_manager.MIMX9596)
include_if_use(component_serial_manager_spi.MIMX9596)
include_if_use(component_serial_manager_swo.MIMX9596)
include_if_use(component_serial_manager_uart.MIMX9596)
include_if_use(component_serial_manager_virtual.MIMX9596)
include_if_use(component_sgtl_adapter.MIMX9596)
include_if_use(component_silicon_id_imx8.MIMX9596)
include_if_use(component_silicon_id_imx93.MIMX9596)
include_if_use(component_silicon_id_imxrt10xx.MIMX9596)
include_if_use(component_silicon_id_imxrt1170.MIMX9596)
include_if_use(component_silicon_id_imxrt1180.MIMX9596)
include_if_use(component_silicon_id_mcxe31x.MIMX9596)
include_if_use(component_silicon_id_mcxn.MIMX9596)
include_if_use(component_silicon_id_rw610.MIMX9596)
include_if_use(component_silicon_id_scfw.MIMX9596)
include_if_use(component_sm_clock.MIMX9596)
include_if_use(component_sm_crc.MIMX9596)
include_if_use(component_sm_imx95_cm33.MIMX9596)
include_if_use(component_sm_imx95_cm7.MIMX9596)
include_if_use(component_sm_pinctrl.MIMX9596)
include_if_use(component_sm_power.MIMX9596)
include_if_use(component_sm_scmi.MIMX9596)
include_if_use(component_sm_smt.MIMX9596)
include_if_use(component_software_crc_adapter.MIMX9596)
include_if_use(component_software_rng_adapter.MIMX9596)
include_if_use(component_srtm_audio_service.MIMX9596)
include_if_use(component_srtm_auto_service.MIMX9596)
include_if_use(component_srtm_i2c_codec_adapter.MIMX9596)
include_if_use(component_srtm_i2c_service.MIMX9596)
include_if_use(component_srtm_io_service.MIMX9596)
include_if_use(component_srtm_keypad_service.MIMX9596)
include_if_use(component_srtm_lfcl_service.MIMX9596)
include_if_use(component_srtm_netc_service.MIMX9596)
include_if_use(component_srtm_pdm_edma_adapter.MIMX9596)
include_if_use(component_srtm_pf1550_adapter.MIMX9596)
include_if_use(component_srtm_pmic_service.MIMX9596)
include_if_use(component_srtm_pwm_adapter.MIMX9596)
include_if_use(component_srtm_pwm_service.MIMX9596)
include_if_use(component_srtm_rtc_service.MIMX9596)
include_if_use(component_srtm_sai_edma_adapter.MIMX9596)
include_if_use(component_srtm_sensor_service.MIMX9596)
include_if_use(component_srtm_snvs_lp_rtc_adapter.MIMX9596)
include_if_use(component_srtm_wm8524_adapter.MIMX9596)
include_if_use(component_tfa9896_adapter.MIMX9596)
include_if_use(component_tfa9xxx_adapter.MIMX9596)
include_if_use(component_timer_manager.MIMX9596)
include_if_use(component_tpm_adapter.MIMX9596)
include_if_use(component_wm8524_adapter.MIMX9596)
include_if_use(component_wm8904_adapter.MIMX9596)
include_if_use(component_wm8960_adapter.MIMX9596)
include_if_use(component_wm8962_adapter.MIMX9596)
include_if_use(device_CMSIS.MIMX9596)
include_if_use(device_RTE.MIMX9596)
include_if_use(device_project_template.MIMX9596)
include_if_use(device_startup.MIMX9596)
include_if_use(device_system.MIMX9596)
include_if_use(driver_adp5585.MIMX9596)
include_if_use(driver_ak4497.MIMX9596)
include_if_use(driver_cache_armv7_m7.MIMX9596)
include_if_use(driver_cache_xcache.MIMX9596)
include_if_use(driver_camera-common.MIMX9596)
include_if_use(driver_camera-device-ap1302.MIMX9596)
include_if_use(driver_camera-device-common.MIMX9596)
include_if_use(driver_camera-device-max9286.MIMX9596)
include_if_use(driver_camera-device-mt9m114.MIMX9596)
include_if_use(driver_camera-device-ov5640.MIMX9596)
include_if_use(driver_camera-device-ov7670.MIMX9596)
include_if_use(driver_camera-device-ov7725.MIMX9596)
include_if_use(driver_camera-device-sccb.MIMX9596)
include_if_use(driver_camera-receiver-common.MIMX9596)
include_if_use(driver_camera-receiver-isi.MIMX9596)
include_if_use(driver_camera_csr.MIMX9596)
include_if_use(driver_clock.MIMX9596)
include_if_use(driver_cmsis_lpi2c.MIMX9596)
include_if_use(driver_cmsis_lpspi.MIMX9596)
include_if_use(driver_cmsis_lpuart.MIMX9596)
include_if_use(driver_codec.MIMX9596)
include_if_use(driver_common.MIMX9596)
include_if_use(driver_cs42448.MIMX9596)
include_if_use(driver_cs42888.MIMX9596)
include_if_use(driver_dbi.MIMX9596)
include_if_use(driver_dc-fb-common.MIMX9596)
include_if_use(driver_dc-fb-dbi.MIMX9596)
include_if_use(driver_dc-fb-dsi-cmd.MIMX9596)
include_if_use(driver_dialog7212.MIMX9596)
include_if_use(driver_display-adv7535.MIMX9596)
include_if_use(driver_display-co5300.MIMX9596)
include_if_use(driver_display-common.MIMX9596)
include_if_use(driver_display-hx8394.MIMX9596)
include_if_use(driver_display-it6161.MIMX9596)
include_if_use(driver_display-it6263.MIMX9596)
include_if_use(driver_display-mipi-dsi-cmd.MIMX9596)
include_if_use(driver_display-rm67162.MIMX9596)
include_if_use(driver_display-rm67191.MIMX9596)
include_if_use(driver_display-rm68191.MIMX9596)
include_if_use(driver_display-rm68200.MIMX9596)
include_if_use(driver_display-rm692c9.MIMX9596)
include_if_use(driver_display-rpi.MIMX9596)
include_if_use(driver_display-sn65dsi83.MIMX9596)
include_if_use(driver_dpu_1.MIMX9596)
include_if_use(driver_edma4.MIMX9596)
include_if_use(driver_edma_soc.MIMX9596)
include_if_use(driver_enet.MIMX9596)
include_if_use(driver_enet_qos.MIMX9596)
include_if_use(driver_fbdev.MIMX9596)
include_if_use(driver_flexcan.MIMX9596)
include_if_use(driver_flexcan_edma.MIMX9596)
include_if_use(driver_flexio.MIMX9596)
include_if_use(driver_flexio_i2c_master.MIMX9596)
include_if_use(driver_flexio_i2s.MIMX9596)
include_if_use(driver_flexio_i2s_edma.MIMX9596)
include_if_use(driver_flexio_spi.MIMX9596)
include_if_use(driver_flexio_spi_edma.MIMX9596)
include_if_use(driver_flexio_uart.MIMX9596)
include_if_use(driver_flexio_uart_edma.MIMX9596)
include_if_use(driver_flexspi.MIMX9596)
include_if_use(driver_flexspi_edma.MIMX9596)
include_if_use(driver_fxas21002cq.MIMX9596)
include_if_use(driver_fxls8974cf.MIMX9596)
include_if_use(driver_fxos8700cq.MIMX9596)
include_if_use(driver_htu21d.MIMX9596)
include_if_use(driver_i3c.MIMX9596)
include_if_use(driver_i3c_edma.MIMX9596)
include_if_use(driver_icm42688p.MIMX9596)
include_if_use(driver_iomuxc.MIMX9596)
include_if_use(driver_irqsteer.MIMX9596)
include_if_use(driver_isi.MIMX9596)
include_if_use(driver_ldb_1.MIMX9596)
include_if_use(driver_lpi2c.MIMX9596)
include_if_use(driver_lpi2c_edma.MIMX9596)
include_if_use(driver_lpi2c_freertos.MIMX9596)
include_if_use(driver_lpit.MIMX9596)
include_if_use(driver_lpspi.MIMX9596)
include_if_use(driver_lpspi_edma.MIMX9596)
include_if_use(driver_lpspi_freertos.MIMX9596)
include_if_use(driver_lptmr.MIMX9596)
include_if_use(driver_lpuart.MIMX9596)
include_if_use(driver_lpuart_edma.MIMX9596)
include_if_use(driver_lpuart_freertos.MIMX9596)
include_if_use(driver_lsm6dso.MIMX9596)
include_if_use(driver_max30101.MIMX9596)
include_if_use(driver_memory.MIMX9596)
include_if_use(driver_mipi_csi2rx_dwc.MIMX9596)
include_if_use(driver_mipi_dsi_imx.MIMX9596)
include_if_use(driver_mma8451q.MIMX9596)
include_if_use(driver_mma8652fc.MIMX9596)
include_if_use(driver_msgintr.MIMX9596)
include_if_use(driver_mu1.MIMX9596)
include_if_use(driver_netc.MIMX9596)
include_if_use(driver_netc_imx95.MIMX9596)
include_if_use(driver_netc_msg.MIMX9596)
include_if_use(driver_netc_phywrapper.MIMX9596)
include_if_use(driver_netc_switch.MIMX9596)
include_if_use(driver_nmh1000.MIMX9596)
include_if_use(driver_p3t1755.MIMX9596)
include_if_use(driver_pca6416a.MIMX9596)
include_if_use(driver_pcal6408.MIMX9596)
include_if_use(driver_pcal6524.MIMX9596)
include_if_use(driver_pcm186x.MIMX9596)
include_if_use(driver_pcm512x.MIMX9596)
include_if_use(driver_pdm.MIMX9596)
include_if_use(driver_pdm_edma.MIMX9596)
include_if_use(driver_pf1550.MIMX9596)
include_if_use(driver_pf3000.MIMX9596)
include_if_use(driver_pf5020.MIMX9596)
include_if_use(driver_rgpio.MIMX9596)
include_if_use(driver_sai.MIMX9596)
include_if_use(driver_sai_edma.MIMX9596)
include_if_use(driver_sar_adc.MIMX9596)
include_if_use(driver_sema42.MIMX9596)
include_if_use(driver_sgtl5000.MIMX9596)
include_if_use(driver_srtm.MIMX9596)
include_if_use(driver_srtm_freertos.MIMX9596)
include_if_use(driver_tfa9896.MIMX9596)
include_if_use(driver_tfa9xxx.MIMX9596)
include_if_use(driver_tfa9xxx_hal.MIMX9596)
include_if_use(driver_tpm.MIMX9596)
include_if_use(driver_trdc_1.MIMX9596)
include_if_use(driver_trdc_soc.MIMX9596)
include_if_use(driver_tsl2561.MIMX9596)
include_if_use(driver_tstmr.MIMX9596)
include_if_use(driver_video-common.MIMX9596)
include_if_use(driver_video-i2c.MIMX9596)
include_if_use(driver_wm8524.MIMX9596)
include_if_use(driver_wm8904.MIMX9596)
include_if_use(driver_wm8960.MIMX9596)
include_if_use(driver_wm8962.MIMX9596)
include_if_use(middleware_audio_voice_components_voice_seeker_cm7_iMX95)
include_if_use(middleware_audio_voice_components_voice_seeker_rdsp_utilities_public_cm7_iMX95)
include_if_use(middleware_baremetal.MIMX9596)
...
include_if_use(middleware_g2d_cm7)
...
include_if_use(middleware_lwip_netc_ethernetif)
include_if_use(middleware_lwip_netc_ethernetif_non_generated_lwipopts)
...
include_if_use(middleware_multicore_rpmsg-lite_imx95_m33)
include_if_use(middleware_multicore_rpmsg-lite_imx95_m7)
...
include_if_use(middleware_voice_spot_cm7_iMX95)
include_if_use(middleware_voice_spot_model)
include_if_use(utilities_misc_utilities.MIMX9596)
include_if_use(utility_assert.MIMX9596)
include_if_use(utility_assert_lite.MIMX9596)
include_if_use(utility_debug_console.MIMX9596)
include_if_use(utility_debug_console_lite.MIMX9596)
include_if_use(utility_debug_console_template_config.MIMX9596)
include_if_use(utility_incbin.MIMX9596)
include_if_use(utility_notifier.MIMX9596)
include_if_use(utility_shell.MIMX9596)
include_if_use(utility_str.MIMX9596)

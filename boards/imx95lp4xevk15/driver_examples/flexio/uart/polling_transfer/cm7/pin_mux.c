...
- pin_list:
  ...
  - {pin_num: M29, peripheral: FLEXIO1, signal: 'flexio_flexio_bit, 3', pin_signal: GPIO_IO03}
  - {pin_num: M28, peripheral: FLEXIO1, signal: 'flexio_flexio_bit, 2', pin_signal: GPIO_IO02}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */

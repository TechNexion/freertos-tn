...
void APP_PullCameraReset(bool reset)
{
    if (reset != false)
    {
        PCAL6524_SetDirection(&pcal_handle, (1 << BOARD_PCAL6524_MIPI_CSI_RST), kPCAL6524_Output);
        PCAL6524_SetPins(&pcal_handle, (1 << BOARD_PCAL6524_MIPI_CSI_RST));
    }
    else
    {
        PCAL6524_SetDirection(&pcal_handle, (1 << BOARD_PCAL6524_MIPI_CSI_RST), kPCAL6524_Output);
        PCAL6524_ClearPins(&pcal_handle, (1 << BOARD_PCAL6524_MIPI_CSI_RST));
    }
}
...
void APP_PullCameraPowerDown(bool powerdown)
{
    if (powerdown != false)
    {
        PCAL6524_SetDirection(&pcal_handle, (1 << BOARD_PCAL6524_MIPI_CSI_EN), kPCAL6524_Output);
        PCAL6524_ClearPins(&pcal_handle, (1 << BOARD_PCAL6524_MIPI_CSI_EN));
    }
    else
    {
        PCAL6524_SetDirection(&pcal_handle, (1 << BOARD_PCAL6524_MIPI_CSI_EN), kPCAL6524_Output);
        PCAL6524_SetPins(&pcal_handle, (1 << BOARD_PCAL6524_MIPI_CSI_EN));
    }
}

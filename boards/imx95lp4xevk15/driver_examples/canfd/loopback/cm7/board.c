...
{
    return BOARD_LPI2C_Send(LPI2C6, deviceAddress, subAddress, subAddressSize, (uint8_t *)txBuff,
                            txBuffSize, 0);
}
...
{
    return BOARD_LPI2C_Receive(LPI2C6, deviceAddress, subAddress, subAddressSize, rxBuff,
                               rxBuffSize, 0);
}

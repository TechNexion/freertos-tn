...
/* I2C service */
#define LPI2C4_BAUDRATE              (400000)
#define I2C_SOURCE_CLOCK_FREQ_LPI2C4 HAL_ClockGetIpFreq(hal_clock_lpi2c4)
...
#define APP_PDM_QUALITY_MODE        (kPDM_QualityModeVeryLow0)
#define APP_PDM_CICOVERSAMPLE_RATE  (0U)
#define APP_PDM_CHANNEL_GAIN        (kPDM_DfOutputGain4)
#define APP_PDM_CHANNEL_CUTOFF_FREQ (kPDM_DcRemoverBypass)

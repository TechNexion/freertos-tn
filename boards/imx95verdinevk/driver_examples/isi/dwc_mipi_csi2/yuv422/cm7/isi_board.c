...
void APP_PullCameraReset(bool reset)
{
    if (reset != false)
    {
        PCAL6524_SetDirection(&pcal_handle, (1 << BOARD_PCAL6524_CAM_RST), kPCAL6524_Output);
        PCAL6524_SetPins(&pcal_handle, (1 << BOARD_PCAL6524_CAM_RST));
    }
    else
    {
        PCAL6524_SetDirection(&pcal_handle, (1 << BOARD_PCAL6524_CAM_RST), kPCAL6524_Output);
        PCAL6524_ClearPins(&pcal_handle, (1 << BOARD_PCAL6524_CAM_RST));
    }
}
...
void APP_PullCameraPowerDown(bool powerdown)
{
    if (powerdown != false)
    {
        PCAL6524_SetDirection(&pcal_handle, (1 << BOARD_PCAL6524_CAM_PWRDWN), kPCAL6524_Output);
        PCAL6524_SetPins(&pcal_handle, (1 << BOARD_PCAL6524_CAM_PWRDWN));
    }
    else
    {
        PCAL6524_SetDirection(&pcal_handle, (1 << BOARD_PCAL6524_CAM_PWRDWN), kPCAL6524_Output);
        PCAL6524_ClearPins(&pcal_handle, (1 << BOARD_PCAL6524_CAM_PWRDWN));
    }
}
